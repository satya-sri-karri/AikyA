    ...
    <div className="landing">
      ...
      <main>
        <section className="landing-hero">
          <motion.div initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, ease: [0.22, 1, 0.36, 1] }}>
            <h1>
              ONE CAMPUS.
              <br />
              <span className="accent-text">EVERYTHING CONNECTED.</span>
            </h1>
            <p className="hero-sub">
              Explore your campus like never before. A digital twin that maps every
              building, floor, room and person — with an AI that actually understands it.
            </p>
          ...
          <div className="landing-viz">
            <span className="map-float-label" style={{ left: "12%", top: "8%" }}>🏫 CSE BLOCK</span>
            <span className="map-float-label" style={{ right: "14%", top: "14%", animationDelay: "1s" }}>📚 LIBRARY</span>
            <span className="map-float-label" style={{ left: "20%", bottom: "16%", animationDelay: "0.6s" }}>🍔 FOOD COURT</span>
            <span className="map-float-label" style={{ right: "8%", bottom: "26%", animationDelay: "1.4s" }}>🚌 BUS STOP</span>
            <span className="map-float-label" style={{ left: "6%", top: "46%", animationDelay: "2s" }}>🏠 HOSTEL</span>
        ...
        <section className="landing-section">
          <Reveal>
            <h2>Everything your campus has, <span className="accent-text">one place.</span></h2>
            <p className="section-sub">
              Buildings, floors, rooms, people, food, transit, hostels, events, services —
              mapped, searchable and connected to the campus intelligence layer.
            </p>
          </Reveal>
